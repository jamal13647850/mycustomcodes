...
class PGBarcode {
     ...
     * @return string
     */
    function CreateBarcode($text,$size=100,$orientation='horizontal',$code_type='code128',$code_string='',$outputtype='base64',$filetype='png',$savepath=''){
